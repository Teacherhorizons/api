...
var tests = shared.addTestGroups(
  ...
  [
    ...
    {
      getUrl: (data) =>
        `regional-regions?schema=not-signed-in-multiple&include=jobs`,
      tests: [
        {
    ...
    {
      getUrl: (data) =>
        `regional-regions?schema=not-signed-in-multiple&filter[slug]=europe`,
      tests: [
        {
    ...
    {
      getUrl: (data) =>
        `regional-regions?schema=not-signed-in-multiple&asUserId=${data.asUserId[0].id}`,
      tests: [
        {
    ...
    {
      getUrl: (data) =>
        `regional-regions?schema=not-signed-in&filter[slug]=europeabc`,
      tests: [
        {
    ...
    {
      getUrl: (data) =>
        `/regional-regions?schema=not-signed-in&filter[slug]=europe`,
      tests: [
        {
    ...
    {
      getUrl: (data) =>
        `/regional-regions?schema=not-signed-in&filter[slug]=europe&include=egg`,
      tests: [
        {
    ...
    {
      getUrl: (data) =>
        `/regional-regions/19?schema=not-signed-in&filter[slug]=europe`,
      tests: [
        {
    ...
    {
      getUrl: (data) =>
        `/regional-regions/999?schema=not-signed-in&include=staff`,
      tests: [
        {
    ...
    {
      getUrl: (data) =>
        `/regional-regions?schema=not-signed-in&filter[slug]=europe&include=staff`,
      tests: [
        {
    ...
    {
      getUrl: (data) =>
        `/regional-regions?schema=not-signed-in&filter[slug]=europe&include=countries`,
      tests: [
        {
    ...
    {
      getUrl: (data) =>
        `/regional-regions?schema=not-signed-in&filter[slug]=europe&include=schools`,
      tests: [
        {
    ...
    {
      getUrl: (data) =>
        `/regional-regions?schema=not-signed-in&filter[slug]=europe&include=jobs`,
      tests: [
        {
    ...
    {
      getUrl: (data) =>
        `/regional-regions?schema=not-signed-in&filter[slug]=europe&include=ambassadors`,
      tests: [
        {
