...
var testsForGet = addTestGroups(
  ...
  [
    {
      getUrl: (data) => `applications?schema=admin&filter[id][contains]=1`,
      tests: [
        {
          name: 'applications?schema=admin&filter[id][contains]=1',
    ...
    {
      getUrl: (data) => `applications?schema=school&filter[id][contains]=1`,
      tests: [
        {
          name: 'applications?schema=school&filter[id][contains]=1',
          userEmail: 'admin@th.test',
          expectedStatus: 200,
        },
        {
    ...
    {
      getUrl: (data) => `applications?schema=teacher&filter[id][contains]=1`,
      tests: [
        {
          name: 'applications?schema=teacher&filter[id][contains]=1',
          userEmail: 'admin@th.test',
          expectedStatus: 200,
        },
        {
