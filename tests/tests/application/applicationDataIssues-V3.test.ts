...
var testsForGet = addTestGroups(
  ...
  [
    ...
    {
      getUrl: (data) =>
        `application-applicationDataIssues?schema=admin&asUserId=${data.asUserId[0].id}&filter[application.id]=${data.dataIssues[0].id}`,
      tests: [
        {
    ...
    {
      getUrl: (data) =>
        `application-applicationDataIssues?schema=admin&asUserId=${data.asUserId[1].id}&filter[application.id]=${data.dataIssues[0].id}`,
      tests: [
        {
    ...
    {
      getUrl: (data) =>
        `application-applicationDataIssues?schema=admin&asUserId=${data.asUserId[2].id}&filter[application.id]=${data.dataIssues[0].id}`,
      tests: [
        {
    ...
    {
      getUrl: (data) =>
        `application-applicationDataIssues?schema=admin&asUserId=${data.asUserId[0].id}&filter[application.id]=a`,
      tests: [
        {
    ...
    {
      getUrl: (data) =>
        `application-applicationDataIssues?schema=admin&asUserId=${data.asUserId[0].id}&filter[application.id]=9999999`,
      tests: [
        {
