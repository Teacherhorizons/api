...
var testsForGet = addTestGroups(
  ...
  [
    {
      getUrl: (data) => `application-applicationDataIssues?schema=admin-v2&filter[application.id]=1`,
      tests: [
        {
          name: 'schema=admin-v2&filter[application.id]=1',
          userEmail: 'signedOut',
    ...
    {
      getUrl: (data) => `application-applicationDataIssues?schema=admin-v2&filter[application.id]=a`,
      tests: [
        {
          name: 'schema=admin-v2&filter[application.id]=a',
          userEmail: 'signedOut',
    ...
    {
      getUrl: (data) => `application-applicationDataIssues?schema=admin-v2&filter[application.id]=9999999`,
      tests: [
        {
          name: 'schema=admin-v2&filter[application.id]=9999999',
          userEmail: 'signedOut',
          expectedStatus: 401, //accessNotPermitted	Must be signed in
        },
        {
